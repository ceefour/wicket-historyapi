 ...
 */
public class UnsecuredWicketAtmosphereHandler extends AbstractReflectorAtmosphereHandler
        implements AtmosphereServletProcessor {
	private static final Logger log = LoggerFactory
			.getLogger(UnsecuredWicketAtmosphereHandler.class);

    private CustomFilterChain filterChain;

    public UnsecuredWicketAtmosphereHandler() {
    	super();
    }
